...
public class SelectorLevelTransition : MonoBehaviour
{
    ...
    public void StartTransition()
    {
        ...
        seq.Append(mask_1st.DOScale(6f, dConstants.VFX.SelectorToLevelAnimTransitionPhase1).SetEase(Ease.InSine));
        ...
        seq.Append(mask_2nd.DOScale(6f, dConstants.VFX.SelectorToLevelAnimTransitionPhase2).SetEase(Ease.InSine));
