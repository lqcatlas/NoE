...
public class SelectorLevelTransition : MonoBehaviour
{
    ...
    public void StartTransition()
    {
        ...
        seq.Append(mask_1st.DOScale(20f, dConstants.VFX.SelectorToLevelAnimTransitionPhase1).SetEase(Ease.InSine));
        ...
        seq.Append(mask_2nd.DOScale(20f, dConstants.VFX.SelectorToLevelAnimTransitionPhase2).SetEase(Ease.InSine));
